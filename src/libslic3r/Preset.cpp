...
static std::vector<std::string> s_Preset_print_options {
    ...
    "raft_layers", "raft_first_layer_density", "raft_first_layer_expansion", "raft_contact_distance", "raft_expansion","raft_base_density", "raft_interface_density", "raft_advanced_params",
